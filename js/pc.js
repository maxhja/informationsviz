function pc(){
    ...
    var margin = [30, 10, 10, 10],
     ...
     var dimensionsOfStock  = ["Company Name","Exchange:Ticker","Industry Group","Bottom up Beta for sector","Bottom up levered beta","Market Cap (in US $)",
                            ...
                            "Standard deviation in stock price","Interest coverage ratio","PEG","EV/EBIT","EV/EBITDA", "EV/Sales",
                            "Historical growth in Net Income - Last 3 years", "held by institutions", "Correlation with market",
